package com.basic.library.view.recyclerview.adapter
...
import com.basic.library.view.recyclerview.MultipleType
...
abstract class CommonAdapter<T>(
    var mContext: Context, var mData: ArrayList<T>,//条目目录
